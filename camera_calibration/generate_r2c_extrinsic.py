...
# Add the arguments
parser.add_argument("--task_name", type=str, help="Path to the data directory")

args = parser.parse_args()
PATH_DATA_PKL = Path(
    f"/home/david/egozero/Franka-Teach/data/processed_data_pkl/{args.task_name}.pkl"
)
PATH_INTRINSICS = None
SAVE_DIR = Path("../calib")
PATH_SAVE_CALIB = SAVE_DIR / f"{args.task_name}.npy"
CAM_IDS = [3, 4]
R2C_TRAJ_IDX = 0
...
if PATH_INTRINSICS is not None and PATH_INTRINSICS.exists():
    ...
    for cam_id in CAM_IDS:
        ...
        intrinsics["distortion_coefficients"][f"cam_{cam_id}"] = (
