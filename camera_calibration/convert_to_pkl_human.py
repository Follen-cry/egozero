...
# from point_utils.hamer.points_class_hammer import PointsClass
...
for TASK_NAME in task_names:
    ...
    for i, data_point in enumerate(sorted(dirs)):
        ...
        try:
            ...
            baseline_sensor_state = np.mean(sensor_states[:5])
        ...
        for i, observation in enumerate(observations):
            for pixel_key in ["pixels1", "pixels2", "pixels3", "pixels4"]:
                ...
                def write_video(frames, points, output_path, include_sensor=False):
                    ...
                    for frame_idx, (frame, frame_points) in enumerate(
                        zip(frames, points)
                    ):
                        frame = frame.copy()
                        ...
                        for point in frame_points:
                            ...
                            cv2.circle(
                                frame, (x, y), radius=3, color=(0, 255, 0), thickness=-1
                            )
